"""
Django settings for ManageCar project.
...
SECRET_KEY = 'django-insecure-e-na$=ss483*05*8ak(1uzwbbed%anb07c%lou4jr!amgqid_2'
...
MEDIA_CAR_ROOT = MEDIA_ROOT / 'car_images'
MEDIA_URL = '/media/'
